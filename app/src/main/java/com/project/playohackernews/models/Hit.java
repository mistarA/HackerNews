...
public class Hit {
  ...
  /*  @Override
    public int hashCode() {
        return new HashCodeBuilder().append(tags).append(storyId).append(storyText).append(highlightResult).append(url).append(numComments).append(parentId).append(commentText).append(author).append(title).append(objectID).append(createdAt).append(storyTitle).append(storyUrl).append(createdAtI).append(points).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        Hit rhs = ((Hit) other);
        return new EqualsBuilder().append(tags, rhs.tags).append(storyId, rhs.storyId).append(storyText, rhs.storyText).append(highlightResult, rhs.highlightResult).append(url, rhs.url).append(numComments, rhs.numComments).append(parentId, rhs.parentId).append(commentText, rhs.commentText).append(author, rhs.author).append(title, rhs.title).append(objectID, rhs.objectID).append(createdAt, rhs.createdAt).append(storyTitle, rhs.storyTitle).append(storyUrl, rhs.storyUrl).append(createdAtI, rhs.createdAtI).append(points, rhs.points).isEquals();
    }*/
